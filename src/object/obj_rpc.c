...
CRT_RPC_DEFINE(obj_agg_barrier, DAOS_ISEQ_OBJ_AGG_BARRIER, DAOS_OSEQ_OBJ_AGG_BARRIER)
CRT_RPC_DEFINE(obj_barrier_state_query, DAOS_ISEQ_OBJ_BARRIER_STATE_QUERY, DAOS_OSEQ_OBJ_BARRIER_STATE_QUERY)
CRT_RPC_DEFINE(obj_ec_parity, DAOS_ISEQ_OBJ_EC_PARITY, DAOS_OSEQ_OBJ_EC_PARITY)
